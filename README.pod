...
Galileo - A simple modern CMS built on Mojolicious - https://github.com/RedOrion/Galileo and https://github.com/LacunaOmnibus/Galileo/commit/3d104ea8cb646a122debe9109d3da510e1c86c9d
...
This is the full path to a configuration file. The default is a file named F<galileo.conf> in the C<GALILEO_HOME> path, however this file need not actually exist, defaults may be used instead. This file need not be written by hand, it can be generated as a result of running the C<galileo config> command.
